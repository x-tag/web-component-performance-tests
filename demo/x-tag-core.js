...
/*** X-Tag Object Definition ***/
  ...
  var xtag = {
    ...
    register: function (name, options) {
      startTimer('x-tag.register:' + name);
      var _name;
      ...
      endTimer('x-tag.register:' + name);
      startTimer('polyfill.registerElement:' + name)
      var reg = doc.registerElement(_name, definition);
      endTimer('polyfill.registerElement:' + name);
      fireReady(_name);
      return reg;
    },
